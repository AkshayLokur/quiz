# Courtesy: https://opentdb.com/api.php?amount=10&category=18&difficulty=easy&type=boolean
question_data = [
    ...
    {"category": "Science: Computers", "type": "boolean", "difficulty": "easy",
     ...
     "incorrect_answers": ["True"]}, {"category": "Science: Computers", "type": "boolean", "difficulty": "easy",
                                      "question": "The Python programming language gets "
                                                  "its name from the British comedy group 'Monty Python.'",
                                      "correct_answer": "True", "incorrect_answers": ["False"]}
]
